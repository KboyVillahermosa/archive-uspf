            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="relative" x-data="{ uploadOpen: false }">
                        <button @click="uploadOpen = !uploadOpen" class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            Upload Research
                        ...
                        <div x-show="uploadOpen" @click.outside="uploadOpen = false" 
                            ...
                            <div class="py-1">
                                <a href="{{ route('student.upload') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                ...
                                <a href="{{ route('faculty.upload') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                ...
                                <a href="{{ route('thesis.upload') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                ...
                                <a href="{{ route('dissertations.upload') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
