    ...
    <div class="min-h-screen bg-[#F3F2EF] py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-black text-[#26225C] tracking-tight">Scholarly Doctoral Dissertation</h1>
                    <p class="text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Advanced Academic Archive Contribution</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                    ...
                    <main class="lg:col-span-8 space-y-4">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/30">
                                <h2 class="text-[11px] font-black text-[#26225C] uppercase tracking-[0.2em]">Dissertation Metadata</h2>
                            ...
                            <div class="p-6 space-y-6">
                                <!-- Title -->
                                <div id="field-title">
                                    <label for="title" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2.5">Dissertation Title <span class="text-rose-500">*</span></label>
                                    <input type="text" name="title" id="title" required
                                        ...
                                        placeholder="Enter full dissertation title..." value="{{ isset($editMode) && $editMode && isset($dissertation) ? $dissertation->title : old('title') }}">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="author" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2.5">Candidate Name <span class="text-rose-500">*</span></label>
                                        <input type="text" name="author" id="author" required
                                            class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#26225C]/10 focus:border-[#26225C] text-sm font-medium transition bg-gray-50/50"
                                            placeholder="Enter full name" value="{{ isset($editMode) && $editMode && isset($dissertation) ? $dissertation->author : old('author') }}">
                                        @error('author') <p class="text-rose-500 text-[10px] mt-2 font-black uppercase">{{ $message }}</p> @enderror
                                    </div>
                                    <div>
                                        <label for="year_completed" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2.5">Completion Year <span class="text-rose-500">*</span></label>
                                ...
                                <div id="field-department" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="department" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2.5">Doctoral Department <span class="text-rose-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="program" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2.5">Postgraduate Program <span class="text-rose-500">*</span></label>
                                ...
                                <div id="field-abstract">
                                    <label for="abstract" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2.5">Doctoral Abstract <span class="text-rose-500">*</span></label>
                                    <textarea name="abstract" id="abstract" rows="14" required
                                        ...
                                        placeholder="Provide a comprehensive summary of your dissertation research project...">{{ isset($editMode) && $editMode && isset($dissertation) ? $dissertation->abstract : old('abstract') }}</textarea>
                                    <div class="flex items-center justify-between mt-2 px-1">
                                        <span class="text-[9px] font-bold text-gray-300 uppercase tracking-widest italic">300-500 word target</span>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="keywords" id="keywords" required
                                        class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#26225C]/10 focus:border-[#26225C] text-sm font-medium transition bg-gray-50/50"
                                        placeholder="Keyword1, Keyword2, Keyword3..." value="{{ isset($editMode) && $editMode && isset($dissertation) ? $dissertation->keywords : old('keywords') }}">
                    ...
                    <aside class="lg:col-span-4 space-y-4">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                            <h4 class="text-[10px] font-black text-[#26225C] uppercase tracking-[0.2em] mb-4">Dissertation Chair</h4>
                            <div id="field-adviser" class="space-y-3">
                                ...
                                <div id="adviser_selected" class="hidden animate-fadeIn p-3 bg-emerald-50 border border-emerald-100 rounded-lg flex items-center justify-between">
                                    <div class="min-w-0">
                                        <p class="text-[10px] font-black text-emerald-900 truncate" id="adviser_name"></p>
                                        <p class="text-[8px] font-bold text-emerald-400 truncate" id="adviser_email"></p>
                                    </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl p-5 shadow-sm space-y-4">
                            <h4 class="text-[10px] font-black text-[#26225C] uppercase tracking-[0.2em]">Required Scholarly Assets</h4>
                            
                            <!-- Abstract PDF -->
                            <div id="field-abstract_file">
                                <label class="block text-[9px] font-black text-gray-400 uppercase tracking-widest mb-2">Doctoral Abstract</label>
                                <div class="upload-zone group border-[1.5px] border-dashed border-gray-200 rounded-lg p-4 text-center bg-gray-50/30 hover:bg-white hover:border-emerald-500 transition-all cursor-pointer relative overflow-hidden">
                            ...
                            <div id="field-document_file">
                                ...
                                <div class="upload-zone group border-[1.5px] border-dashed border-gray-200 rounded-lg p-4 text-center bg-gray-50/30 hover:bg-white hover:border-emerald-500 transition-all cursor-pointer relative overflow-hidden">
                                    ...
                                    <label for="document_file" class="cursor-pointer block">
                                        <p class="text-[10px] font-black text-[#26225C] truncate px-2">Select Dissertation</p>
                                        <p class="text-[8px] text-gray-400 font-bold uppercase tracking-widest mt-1 opacity-60">PDF ONLY • 10MB</p>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="sticky bottom-6">
                            ...
                            <p class="text-[9px] text-center text-gray-400 font-bold uppercase tracking-widest mt-4">Advanced Archival Tracking Engaged</p>
                        </div>
                    </aside>
    ...
    <script>
        function scrollToField(fieldId) {
            ...
            if (el) {
                ...
                setTimeout(() => el.classList.remove('ring-1', 'ring-emerald-400'), 2000);
            }
        }
        ...
        function updateProgress() {
            ...
            if (filled === fields.length && status) {
                ...
                status.className = 'text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded';
            }
        }
        ...
        ['abstract_file', 'document_file'].forEach(id => {
            ...
            el.addEventListener('change', e => {
                if (e.target.files.length > 0) {
                    ...
                    zone.classList.add('border-emerald-500', 'bg-emerald-50/20');
        ...
        document.getElementById('dissertation-upload-form').addEventListener('submit', async function(e) {
            e.preventDefault();
            ...
            try {
                ...
                if (data.status === 'success') {
                    await saveCits(data.research_id, 'dissertation');
                    window.location.href = '{{ route("research.history") }}';
                } else {
                    let msg = data.message || 'Submission error. Please check all scholarly metrics.';
                    if (data.errors) msg = Object.values(data.errors).flat().join('\n');
                    alert(msg);
                    btn.disabled = false;
                    btn.innerHTML = 'Submit Dissertation';
                }
            } catch (err) {
