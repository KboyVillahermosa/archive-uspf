    ...
    <script>
        ...
        function showTab(tabName) {
            ...
            document.querySelectorAll('[id$="-tab"]').forEach(tab => {
                tab.classList.remove('border-green-500', 'text-green-600', 'active-tab');
            ...
            activeTab.classList.add('border-green-500', 'text-green-600', 'active-tab');
        ...
        function displayCitations(citations, container, type) {
            if (citations.length === 0) {
                const message = type === 'cited-by' 
                    ? 'This thesis has not cited any other research in our database.'
                    : 'No other research has cited this thesis yet.';
