    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-blue-100 text-blue-600 border border-blue-200">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="relative h-64">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent">
                            <div class="absolute bottom-6 left-6 right-6">
                                <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-blue-600/90 text-white mb-3">
                                    <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C20.832 18.477 19.246 18 17.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                    </svg>
                                    Student Research
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    @if(!$research->banner_image)
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                            <div class="bg-gradient-to-r from-blue-50 to-blue-100 px-8 py-6 border-b border-gray-100">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ $research->title }}</h1>
                                        <p class="text-gray-600">Student Research • {{ $research->approved_at->format('Y') }}</p>
                                    </div>
                                ...
                                <div class="flex flex-wrap items-center gap-6 mb-8">
                                    <div class="flex items-center text-gray-600">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-semibold text-gray-900">{{ $research->authors }}</p>
                                        </div>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <h3 class="font-semibold text-gray-700">Program</h3>
                                    </div>
                                    <p class="text-gray-900 font-medium">{{ $research->program }}</p>
                                </div>
                            </div>
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        @foreach(explode(',', $research->tags) as $tag)
                                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-blue-100 text-blue-600 border border-blue-200 hover:bg-blue-200 transition-colors">
                                                {{ trim($tag) }}
                                            </span>
                                        @endforeach
                                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-8">
                            <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border-l-4 border-blue-500">
                                ...
                                <button onclick="copyToClipboard()" class="inline-flex items-center px-4 py-2 text-sm text-blue-600 hover:text-blue-800 hover:bg-blue-100 rounded-lg transition-all duration-200 font-semibold">
                                    <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div id="cited-research-list">
                                    <div class="text-center py-8">
                                        <div class="inline-flex items-center">
                                            <svg class="animate-spin h-6 w-6 mr-3 text-blue-600" fill="none" viewBox="0 0 24 24">
                ...
                <div class="space-y-8">
                            ...
                            <div class="space-y-4">
                                @if($research->research_file)
                                    <a href="{{ route('student.download-survey', $research->id) }}" 
                                       class="mp-form flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-blue-50 to-blue-100 px-6 py-4 border-b border-gray-100">
                            <h3 class="text-lg font-bold text-gray-900">Submitted By</h3>
                        </div>
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="h-16 w-16 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center">
                                    <span class="text-blue-600 font-bold text-xl">
                                        {{ substr($research->user->name, 0, 2) }}
                                    </span>
                                </div>
                                <div class="ml-4">
                                    <p class="font-bold text-gray-900 text-lg">{{ $research->user->name }}</p>
                                    <p class="text-sm text-gray-600 font-medium">{{ $research->user->email }}</p>
                                    <p class="text-sm text-gray-600">Research Contributor</p>
                                </div>
                            </div>
                        </div>
                    </div>
