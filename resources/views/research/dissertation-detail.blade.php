                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                @if($dissertation->document_file)
                                    <a href="{{ route('dissertation.download', $dissertation->id) }}" 
                                       class="flex items-center justify-center w-full px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition duration-200">
                                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-semibold text-gray-900">{{ rand(200, 2000) }}</span>
                                </div>
                                <div class="flex justify-between items-center">
        ...
        function shareResearch() {
            if (navigator.share) {
                ...
                navigator.clipboard.writeText(window.location.href).then(() => {
                    alert('Dissertation link copied to clipboard!');
                });
            }
        }
    </script>
