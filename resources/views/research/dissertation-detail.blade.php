    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-red-100 text-red-600 border border-red-200">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-red-50 to-red-100 px-8 py-6 border-b border-gray-100">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ $dissertation->title }}</h1>
                                    <p class="text-gray-600">Doctoral Dissertation • {{ $dissertation->year_completed }}</p>
                                </div>
                        ...
                        <div class="p-8">
                            <div class="flex flex-wrap items-center gap-6 mb-8">
                                <div class="flex items-center text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-900">{{ $dissertation->author }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-900">{{ $dissertation->year_completed }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
                                    ...
                                    <p class="text-gray-900 font-medium">{{ $dissertation->department }}</p>
                                </div>
                                <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
                                    <div class="flex items-center mb-3">
                                        <div class="p-2 bg-red-100 rounded-lg mr-3">
                                    ...
                                    <p class="text-gray-900 font-medium">Doctoral Degree</p>
                                </div>
                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    @foreach(explode(',', $dissertation->keywords) as $keyword)
                                        <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-red-100 text-red-600 border border-red-200 hover:bg-red-200 transition-colors">
                                            {{ trim($keyword) }}
                                        </span>
                                    @endforeach
                                </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-8">
                            <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-xl border-l-4 border-red-500">
                                ...
                                <button onclick="copyToClipboard()" class="inline-flex items-center px-4 py-2 text-sm text-red-600 hover:text-red-800 hover:bg-red-100 rounded-lg transition-all duration-200 font-semibold">
                                    <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-8">
                            ...
                            <div id="cited-by-content" class="tab-content">
                                <div class="mb-6">
                                    <h4 class="font-bold text-gray-800 mb-2">References cited in this dissertation</h4>
                                ...
                                <div id="cited-research-list">
                                    <div class="text-center py-8">
                                        <div class="inline-flex items-center">
                                            <svg class="animate-spin h-6 w-6 mr-3 text-red-600" fill="none" viewBox="0 0 24 24">
                            ...
                            <div id="cites-this-content" class="tab-content hidden">
                                <div class="mb-6">
                                    <h4 class="font-bold text-gray-800 mb-2">Research that references this dissertation</h4>
                            ...
                            <div class="space-y-4">
                                @if($dissertation->document_file)
                                    <a href="{{ route('dissertation.download-survey', $dissertation->id) }}" 
                                       class="mp-form flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    ...
                                    <span class="font-bold text-gray-900">Doctoral Dissertation</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    <span class="text-gray-600 font-medium">Year Completed</span>
                                    <span class="font-bold text-gray-900">{{ $dissertation->year_completed }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    <span class="text-gray-600 font-medium">Department</span>
                                    <span class="font-bold text-gray-900 text-right text-sm">{{ $dissertation->department }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3">
                                    <span class="text-gray-600 font-medium">Published</span>
                                    <span class="font-bold text-gray-900">{{ $dissertation->approved_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    ...
                                    <span class="font-bold text-gray-900 text-xl">{{ rand(5, 50) }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3">
                                    <span class="text-gray-600 font-medium flex items-center">
                                        <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span class="font-bold text-gray-900 text-xl">{{ $dissertation->approved_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="h-16 w-16 bg-gradient-to-br from-red-100 to-red-200 rounded-xl flex items-center justify-center">
                                    <span class="text-red-600 font-bold text-xl">
                                        {{ substr($dissertation->author, 0, 2) }}
                                    </span>
                                </div>
                                <div class="ml-4">
                                    <p class="font-bold text-gray-900 text-lg">{{ $dissertation->author }}</p>
                                    <p class="text-sm text-gray-600 font-medium">Doctoral Graduate</p>
